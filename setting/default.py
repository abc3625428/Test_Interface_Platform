...
path  = os.path.abspath(os.path.dirname(__file__)).replace('setting','logs')
...
class DefaultConfig(object):
    ...
    # 日志
    LOGGING_LEVEL = 'DEBUG'
    LOGGING_FILE_DIR = path
    LOGGING_FILE_MAX_BYTES = 500 * 1024 * 1024
    LOGGING_FILE_BACKUP = 10

    #数据库
    SQLALCHEMY_BINDS = {
        'bj-m1': 'mysql+pymysql://root:123456@127.0.0.1:3306/data_master',
        'bj-s1': 'mysql+pymysql://root:123456@127.0.0.1:3306/data_master',
        'masters': ['bj-m1'],
        'slaves': ['bj-s1'],
        'default': 'bj-m1'
    }
